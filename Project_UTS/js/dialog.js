...
awal_cerita[1] = [
  0,
  "Seingatku aku tertidur di bangku kelas. Kenapa tiba-tiba aku disini?",
  "next",
];
awal_cerita[2] = [
  0,
  "Daerah ini aneh sekali, bangunannya terlihat kuno seperti masa lalu saja.",
  "next",
];
...
talk_1[1] = [5, "Ini desa jawir, kamu berasal dari mana?", "next"];
talk_1[2] = [0, "Saya dari Surabaya pak", "next"];
talk_1[3] = [5, "Surabaya, mmmmm.... saya belum pernah dengar", "next"];
talk_1[4] = [
  5,
  "Cobalah kamu ke resto, mungkin kamu bisa bertanya-tanya",
  "next",
];
talk_1[5] = [
  5,
  "Tapi, kamu jangan pergi ke hutan! Disana banyak monster",
  "next",
];
...
talk_2[0] = [
  2,
  "Selamat datang di penginapan kami. Istirahat dapat memulihkan energi, terutama sehabis bertempur.",
  "next",
];
...
item_0[0] = [
  ...
  10,
  0,
  "Memulihkan energimu 100% sehingga siap bertempur kembali esok hari",
];
...
talk_3[1] = [
  7,
  "Hal itu bermanfaat jika kamu kelelahan sehabis bertempur",
  "next",
];
...
item_1[0] = [
  ...
  5,
  0,
  "Memulihkan energimu sebesar 5 poin",
];
item_1[1] = [
  1,
  2,
  ...
  10,
  0,
  "Memulihkan energimu sebesar 10 poin",
];
...
item_2[0] = [
  ...
  5,
  1,
  "Pedang kayu cocok untuk pemula. Meningkatkan serangan sebesar 5 Poin",
];
item_2[1] = [
  1,
  0,
  ...
  12,
  2,
  "Golok tajam, senjata berbahaya yang dapat meningkatkan serangan sebesar 12 poin. Butuh level 2 untuk menggunakannya",
];
item_2[2] = [
  2,
  0,
  ...
  18,
  3,
  "Pedang para pendekar, meningkatkan daya serang sebesar 18 poin. Butuh level 4 untuk menggunakannya",
];
item_2[3] = [
  3,
  0,
  ...
  4,
  4,
  "Perisai kayu cocok untuk pemula, meningkatkan daya tahan sebesar 4 poin",
];
item_2[4] = [
  0,
  1,
  ...
  9,
  5,
  "Perisai kuningan lebih kuat, mampu melindungi sebesar 9 poin. Butuh level 2 untuk menggunakannya",
];
item_2[5] = [
  1,
  1,
  ...
  12,
  6,
  "Perisai ini dapat meningkatkan daya tahan sebesar 12 poin.. Butuh level 3 untuk menggunakannya",
];
item_2[6] = [
  2,
  1,
  ...
  10,
  7,
  "Obat untuk memulihkan energi di saat pertempuran berlangsung",
];
item_2[7] = [
  3,
  1,
  ...
  25,
  0,
  "Bahan bacaan untuk memperkaya wawasan dan menambah pengalaman",
];
